 ...
 */
class SingleCameraIntrinsics {
public:
    /**
     * @brief Default constructor
     */
    SingleCameraIntrinsics() = default;
     ...
     */
    SingleCameraIntrinsics(const std::string& extrinsics_file_path, const std::string& intrinsics_file_path);
