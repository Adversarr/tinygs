...
void half_to_float_gpu(float* dst, const float16_t* src, int n, cudaStream_t stream = nullptr);
void float_to_half_gpu(float16_t* dst, const float* src, int n, cudaStream_t stream = nullptr);
